...
revoke all on function public.record_boss_kill(text,text,integer) from public;
grant execute on function public.record_boss_kill(text,text,integer) to authenticated;
